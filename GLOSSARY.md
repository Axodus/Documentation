...
This glossary defines common Axodus terms.
...
**Executive DAO**: The strategic and executive coordination layer for roadmap alignment, technical prioritization, and operational execution.

**Boardroom Council**: A supervisory and validation layer for higher-impact proposals, risk review, and governance filtering.

**Community DAO**: The open participation layer for public proposals, voting, and community governance.

**Constitutional Governance**: Governance based on shared principles, constraints, and operating rules defined by the Axodus Constitution.

**Local Governance**: DAO-specific governance that operates with autonomy while remaining aligned with constitutional constraints.
...
**Morpheus**: An ACS agent archetype focused on strategy, narrative, governance alignment, and ecosystem coherence.

**Trinity**: An ACS agent archetype focused on trading intelligence, operations, P&L analysis, risk monitoring, and execution support.

**Agent Smith**: An ACS agent archetype focused on adversarial review, stress testing, abuse resistance, and risk challenge.

**Academy**: The education, onboarding, certification, Learn-to-Win, Proof of Knowledge, and token utility nucleus.

**Learn-to-Win**: A gamified education model where users progress through learning activities and may become eligible for rewards or access rules.

**Proof of Knowledge**: A validation model for demonstrating learning, assessment completion, or certification progress.

**Marketplace**: The distribution layer for courses, licenses, services, agents, infrastructure, and other ecosystem products.

**Treasury**: The capital layer responsible for allocation, preservation, productive deployment, reporting, and risk control.

**Accountability**: The continuous publication of financial reports, governance records, release notes, roadmap updates, and risk disclosures.
...
**Locked Rewards**: Rewards that may be restricted for internal use, non-transferable, or subject to unlock rules depending on contract implementation.

**Token Utility**: Functional use of a token for access, governance, rewards, marketplace participation, or coordination.
