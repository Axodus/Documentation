...
- Graph nodes with canonical IDs: 28
- Declared relationship edges: 52
- Relationship types: 3
- Broken or missing references: 0
- Duplicate references: 0
- Documents without semantic relationships: 649
- Documents unreachable from master index: 0
- Potential cycles: 4
...
- DOC-ADR-001 → DOC-ADR-003 → DOC-ADR-006 → DOC-ADR-012 → DOC-ADR-017
- DOC-ADR-005 → DOC-ADR-011 → DOC-ADR-016
- DOC-ADR-007 → DOC-ADR-013 → DOC-ADR-014
- DOC-ADR-008 → DOC-ADR-015
...
No semantic conflict is inferred. Relationship anomalies are reported only from declared metadata.
