...
implementation_refs: [{repository: "Axodus/Documentation", path: ".rag/DOCUMENTATION-ADOPTION-METRICS.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}, {repository: "Axodus/Documentation", path: ".rag/DOCUMENTATION-CORE-ADOPTION-MATRIX.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
