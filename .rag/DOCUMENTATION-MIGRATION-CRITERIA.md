...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation.schema.json", ref: "main", kind: "CONFIG", environment: "LOCAL"}, {repository: "Axodus/Documentation", path: ".rag/DOCUMENTATION-VALIDATION-RULES.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
