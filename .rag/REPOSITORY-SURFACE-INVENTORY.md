...
- Reviewed material nested surfaces under `docs/.vitepress/`, `.rag/`,
...
| `SURFACE-EP4-0009` | `.rag/` | `DOCUMENTATION_GOVERNANCE` | `129` files, `129` Markdown | tracked, public inventory included, generated and authored mix | Documentation governance reports, indexes, audits, plans, and generated Markdown | `KEEP_WITH_BOUNDARY_HARDENING` |
...
| `SURFACE-EP4-0033` | `.rag/` generated Markdown set | `GENERATED_OUTPUT` | `4` generated Markdown files | Master index, metadata coverage, relationship report, deterministic rules | `KEEP_AS_IS` |
| `SURFACE-EP4-0034` | `.rag/` authored governance corpus | `DOCUMENTATION_GOVERNANCE` | `125` authored Markdown inputs | Epic records, audits, plans, governance reports | `KEEP_AS_IS` |
...
`.rag/` remains the governance namespace. Evidence supports keeping
...
to `.rag/`, but its own README defines it as a holding area for
...
separate from `docs/`, `.rag/`, and any future root consolidation.
...
- `.rag/` generated Markdown: public generator outputs;
...
| `.rag/` | authored/generated coexistence | same namespace contains inputs and generated Markdown outputs |
...
| Governance Markdown under `.rag/` | `129` |
| Authored governance inputs under `.rag/` | `125` |
| Generated governance Markdown under `.rag/` | `4` |
