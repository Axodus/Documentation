...
implementation_refs: [{repository: "Axodus/Documentation", path: ".rag/EPIC-08-CLAIM-TRACEABILITY-REGISTER.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
...
| `CLAIM-EP8-0018` | Runtime provider adapters are closed. | `docs/runtime/overview.md` | `.rag/EPIC-07-INTERFACE-EVENT-DATA-REGISTER.md` | Runtime | `PRODUCTION` | provider/runtime authority absent | `EVID-EP8-0002` | not implemented/activated / `F2` | credentials and provider private | Preserve closed gate. | `FULLY_TRACEABLE` |
