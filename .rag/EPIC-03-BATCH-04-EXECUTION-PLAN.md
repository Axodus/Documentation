...
implementation_refs: [{repository: "Axodus/Documentation", path: ".rag/EPIC-03-BATCH-04-CANDIDATE-REGISTER.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}, {repository: "Axodus/Documentation", path: ".rag/EPIC-03-BATCH-04-ROLLBACK-PLAN.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
...
- `.rag/EPIC-03-BATCH-04-CANDIDATE-REGISTER.md` for execution state;
