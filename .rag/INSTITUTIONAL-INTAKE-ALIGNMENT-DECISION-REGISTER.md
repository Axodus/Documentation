...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `ALIGN-EP4-0001` | Maturity taxonomy | `INTAKE-EP4-0001` | `governance/maturity-taxonomy.md` | `governance/DOCUMENTATION-LIFECYCLE.md`; `.rag/EPIC-03-MATURITY-AND-DEVELOPMENT-ASSESSMENT.md` | `DUAL_AUTHORITY_BY_SCOPE` | Scope-qualified crosswalk | No prose mirror; metadata and decision notes only | Mandatory source attribution for Institutional L/D references | Required | Schema `maturity_level` never maps directly to Institutional D-Level or L-Level | `NO` | Documentation Coordinator / Institutional Editorial Reviewer | Taxonomy, schema, or maturity-assessment change | `ACTIVE` | Alignment completed without release |
