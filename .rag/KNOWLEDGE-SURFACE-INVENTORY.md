...
| Generated reports | `.rag/*` outputs | Preserve generated links to `.knowledge/**` |
| Institutional intake records | `.rag/INSTITUTIONAL-*` and `.rag/CROSS-REPOSITORY-*` | Reference `.knowledge/core/terminology.akp.md` and `.knowledge/glossary/` as Documentation equivalents |
