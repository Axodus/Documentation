...
- `.rag/DOCUMENTATION-MASTER-INDEX.md`,
  `.rag/DOCUMENTATION-METADATA-COVERAGE.md`, and
  `.rag/DOCUMENTATION-RELATIONSHIP-REPORT.md`;
- `.rag/DOCUMENTATION-TRACEABILITY-DEPTH-BASELINE.md`,
  `.rag/DOCUMENTATION-GRAPH-ENRICHMENT-REPORT.md`, and
  `.rag/DOCUMENTATION-TRACEABILITY-EXPANSION.md`;
- `.rag/DOCUMENTATION-GENERATOR-DRIFT-INVESTIGATION.md` and
  `.rag/DOCUMENTATION-GENERATOR-DRIFT-RECONCILIATION-PLAN.md`;
