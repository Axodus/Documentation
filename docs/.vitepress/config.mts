...
const accountabilityItems = [
  { text: 'Overview', link: '/accountability/overview' },
  { text: 'Financial Reports', link: '/accountability/financial-reports' },
  { text: 'Roadmap Updates', link: '/accountability/roadmap-updates' },
  { text: 'Governance Records', link: '/accountability/governance-records' },
  { text: 'Release Notes', link: '/accountability/release-notes' }
]

const securityItems = [
  { text: 'Overview', link: '/security/overview' },
  { text: 'Smart Contract Security', link: '/security/smart-contract-security' },
  { text: 'Frontend Security', link: '/security/frontend-security' },
  { text: 'API Security', link: '/security/api-security' },
  { text: 'Wallet Security', link: '/security/wallet-security' },
  { text: 'Trading API Security', link: '/security/trading-api-security' },
  { text: 'Disclosure Policy', link: '/security/disclosure-policy' }
]
...
const defiItems = [
  { text: 'Overview', link: '/defi/overview' },
...
const referenceItems = [
  ...
  { text: 'Risk Notices', link: '/overview/risk-notices' },
  { text: 'Documentation Standards', link: '/overview/documentation-standards' }
]
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Products', items: [
        ...
        { text: 'DEX', link: '/dex/overview' },
        { text: 'Mining', link: '/mining/overview' },
        { text: 'Lottery / CryptoDraw', link: '/lottery/overview' },
        { text: 'Marketplace', link: '/marketplace/overview' },
        { text: 'Academy', link: '/academy/overview' }
      ] },
      { text: 'Operations', items: [
        { text: 'Business', link: '/business/overview' },
        { text: 'BBA Agency', link: '/bba-agency/overview' },
        { text: 'ACS / AI Agents', link: '/acs/overview' },
        { text: 'Runtime', link: '/runtime/overview' },
        { text: 'Reporting', link: '/accountability/overview' }
      ] },
      { text: 'Developers', items: [
        { text: 'Security', link: '/security/overview' },
        { text: 'Runtime', link: '/runtime/overview' },
        { text: 'DEX Architecture', link: '/dex/architecture' },
        { text: 'Token Architecture', link: '/tokenomics/technical-architecture' },
        { text: 'Documentation Standards', link: '/overview/documentation-standards' }
      ] },
      { text: 'Glossary', link: '/glossary/terms' }
    ],
    sidebar: [
      ...
      {
        text: 'Governance & Control',
        collapsed: false,
        items: [
          { text: 'Governance', collapsed: true, items: governanceItems },
          { text: 'Treasury', collapsed: true, items: treasuryItems },
          { text: 'Tokenomics', collapsed: true, items: tokenomicsItems },
          { text: 'Accountability', collapsed: true, items: accountabilityItems },
          { text: 'Security', collapsed: true, items: securityItems },
          { text: 'Runtime', collapsed: true, items: runtimeItems }
        ]
      },
      {
        text: 'User & Ecosystem Journey',
        collapsed: false,
        items: [
          { text: 'Academy', collapsed: true, items: academyItems },
          { text: 'Marketplace', collapsed: true, items: marketplaceItems },
          { text: 'Business', collapsed: true, items: businessItems },
          { text: 'BBA Agency', collapsed: true, items: bbaAgencyItems },
          { text: 'ACS / AI Agents', collapsed: true, items: acsItems }
        ]
      },
      {
        text: 'Products & Protocols',
        collapsed: false,
        items: [
          { text: 'Trading', collapsed: true, items: tradingItems },
          { text: 'DeFi / DaaS', collapsed: true, items: defiItems },
          { text: 'DEX', collapsed: true, items: dexItems },
          { text: 'Mining', collapsed: true, items: miningItems },
          { text: 'Lottery / CryptoDraw', collapsed: true, items: lotteryItems }
        ]
      },
      {
        text: 'Reference',
    ...
    search: {
      ...
      options: {
        detailedView: true,
        placeholder: 'Search Axodus docs'
      }
    },
    outline: {
      level: [2, 3],
    ...
    footer: {
      message: 'Released as living documentation for the Axodus ecosystem.',
      copyright: '© Axodus. Documentation under active reconstruction.'
    },
    editLink: {
      pattern: 'https://github.com/Axodus/Documentation/edit/main/docs/:path',
      text: 'Edit this page on GitHub'
    },
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Axodus/Documentation' }
    ]
  },
  markdown: {
    theme: {
