...
| DOC-BLOCK-003 | High | Open | Official GitBook alignment not fully validated in REQ-02. | Public documentation may drift from local/current source-of-truth docs. | REQ-03 Documentation Asset Inventory & GitBook Alignment. |
