...
|---|---|---|---|---|
| `LEGACY-RISK-001` | Namespace ambiguity between `Documents/` and `documentation/` | `HIGH` | execute bounded rename only; do not merge content | controlled |
