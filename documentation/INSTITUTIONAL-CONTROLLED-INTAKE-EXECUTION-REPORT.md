...
|---|---|---|---|---|
| `INTAKE-EP4-0004` | `METADATA_ONLY_INTAKE` | `documentation/INSTITUTIONAL-TERMINOLOGY-INTAKE-REGISTER.md` | `ABSORBED_METADATA_ONLY` | `SEMANTICALLY_PRESERVED_WITH_NORMALIZATION` |
| `INTAKE-EP4-0005` | `METADATA_ONLY_INTAKE` | `documentation/INSTITUTIONAL-CLAIMS-METADATA-INTAKE-REGISTER.md` | `ABSORBED_METADATA_ONLY` | `SEMANTICALLY_PRESERVED_WITH_NORMALIZATION` |
| `INTAKE-EP4-0006` | `BOUNDED_ANALYTICAL_ABSORPTION` | `documentation/INSTITUTIONAL-RESEARCH-GAPS-INTAKE-REGISTER.md` | `ABSORBED_BOUNDED_ANALYTICAL_RECORD` | `SEMANTICALLY_PRESERVED_WITH_NORMALIZATION` |
| `INTAKE-EP4-0007` | `BOUNDED_ANALYTICAL_ABSORPTION` | `documentation/INSTITUTIONAL-AUTHOR-ECOSYSTEM-CLARIFICATION-INTAKE.md` | `ABSORBED_BOUNDED_ANALYTICAL_RECORD` | `SEMANTICALLY_PRESERVED_WITH_LIMITATIONS` |
| `INTAKE-EP4-0008` | `BOUNDED_ANALYTICAL_ABSORPTION` | `documentation/INSTITUTIONAL-PAPER-SCOPE-IMPACT-INTAKE.md` | `ABSORBED_BOUNDED_ANALYTICAL_RECORD` | `SEMANTICALLY_PRESERVED_WITH_LIMITATIONS` |
...
Eight canonical reports were created under `documentation/`. All use
