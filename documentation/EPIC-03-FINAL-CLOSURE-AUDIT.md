...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation/EPIC-03-FINAL-RECONCILIATION-REPORT.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}, {repository: "Axodus/Documentation", path: "documentation/EPIC-03-RESIDUAL-BACKLOG-REGISTER.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
...
`documentation/`. No request is marked complete without a validation-bearing
