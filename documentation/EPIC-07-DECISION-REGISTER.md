...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation/EPIC-07-DECISION-REGISTER.md", ref: "main", kind: "SOURCE", environment: "LOCAL"}]
...
| `DEC-EP7-0002` | REQ-01 through REQ-06 may change only `documentation/` reports and the authorized private ledger. | Freeze must precede public remediation. | `docs/` delta must remain zero. |
