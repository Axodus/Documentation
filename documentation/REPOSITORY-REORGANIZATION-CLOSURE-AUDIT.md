...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation/REPOSITORY-TOPOLOGY-FINAL-REPORT.md", ref: "WORKTREE", kind: "SOURCE", environment: "LOCAL"}, {repository: "Axodus/Documentation", path: "documentation/REPOSITORY-REORGANIZATION-FINAL-BOUNDARY-AUDIT.md", ref: "WORKTREE", kind: "SOURCE", environment: "LOCAL"}]
