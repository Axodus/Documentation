...
| Governed registry-facing report | `documentation/DOCUMENTATION-EXCEPTION-DISPOSITION-INVENTORY.md` | path inventory must reconcile with registry source |
| Operational evidence references | `documentation/EPIC-03-TRACEABILITY-REMEDIATION-INVENTORY.md`, `documentation/EPIC-03-TRACEABILITY-RISK-REVIEW.md` | referenced path evidence needed the live successor path |
...
- `documentation/DOCUMENTATION-DETERMINISTIC-GENERATION-RULES.md` when required
