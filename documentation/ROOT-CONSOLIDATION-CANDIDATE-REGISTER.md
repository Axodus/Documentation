...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation/ROOT-CANONICAL-DIRECTORY-INVENTORY.md", ref: "WORKTREE", kind: "SOURCE", environment: "LOCAL"}]
...
| `ROOT-EP4-0010` | `documentation/` | Keep as governance root | governance namespace | LOW | generator reports | `REJECT_KEEP_AS_CANONICAL_ROOT` | no | Rename would create churn with no benefit |
...
| `ROOT-EP4-0022` | `reports/` | Plan-only consolidation review | sparse canonical collection | MEDIUM | registries, generated inventory | `FREEZE_FOR_REVIEW` | no | Could conflict with `documentation/` reports |
