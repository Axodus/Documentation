...
implementation_refs: [{repository: "Axodus/Documentation", path: "documentation/ROOT-CONSOLIDATION-CANDIDATE-REGISTER.md", ref: "WORKTREE", kind: "SOURCE", environment: "LOCAL"}]
...
| `ROOT-RISK-0008` | Documentation namespace churn | HIGH | `documentation/` contains many canonical reports and generated artifacts | Reject rename or merge | CONTROLLED |
