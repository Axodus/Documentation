...
|---|---:|---|
| `documentation/` | 109 | Governance reports, generated indexes, epic evidence, and intake target |
...
| L/D assessment usage | `documentation/EPIC-03-MATURITY-AND-DEVELOPMENT-ASSESSMENT.md` | Assessment evidence exists; shared taxonomy authority unresolved |
...
| Evidence snapshots | `documentation/DOCUMENTATION-EVIDENCE-FRAMEWORK.md` | Internal snapshot evidence only; not public claim-evidence authority |
...
`documentation/DOCUMENTATION-DETERMINISTIC-GENERATION-RULES.md` remains
