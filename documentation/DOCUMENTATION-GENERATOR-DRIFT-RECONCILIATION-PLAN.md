...
5. `documentation/DOCUMENTATION-MASTER-INDEX.md`
6. `documentation/DOCUMENTATION-METADATA-COVERAGE.md`
7. `documentation/DOCUMENTATION-RELATIONSHIP-REPORT.md`
...
`documentation/DOCUMENTATION-DETERMINISTIC-GENERATION-RULES.md` may also
