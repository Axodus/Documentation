...
- Canonical metadata field coverage: 6.20%
- Schema 1.0.0 compliant documents: 28
- Legacy documents: 635
- Documents missing one or more canonical fields: 635
...
|---|---:|---:|---:|
| `schema_version` | 42 | 635 | 6.20% |
| `document_id` | 42 | 635 | 6.20% |
| `aliases` | 42 | 635 | 6.20% |
| `document_type` | 42 | 635 | 6.20% |
| `title` | 42 | 635 | 6.20% |
| `summary` | 42 | 635 | 6.20% |
| `version` | 42 | 635 | 6.20% |
| `publication_status` | 42 | 635 | 6.20% |
| `document_state` | 42 | 635 | 6.20% |
| `maturity_level` | 42 | 635 | 6.20% |
| `authority_scope` | 42 | 635 | 6.20% |
| `authority_level` | 42 | 635 | 6.20% |
| `author` | 42 | 635 | 6.20% |
| `owner` | 42 | 635 | 6.20% |
| `maintainer` | 42 | 635 | 6.20% |
| `technical_reviewers` | 42 | 635 | 6.20% |
| `business_reviewers` | 42 | 635 | 6.20% |
| `security_reviewers` | 42 | 635 | 6.20% |
| `approver` | 42 | 635 | 6.20% |
| `created_date` | 42 | 635 | 6.20% |
| `last_updated` | 42 | 635 | 6.20% |
| `last_reviewed` | 42 | 635 | 6.20% |
| `review_cycle` | 42 | 635 | 6.20% |
| `next_review` | 42 | 635 | 6.20% |
| `supersedes` | 42 | 635 | 6.20% |
| `relationships` | 42 | 635 | 6.20% |
| `related_epics` | 42 | 635 | 6.20% |
| `related_requirements` | 42 | 635 | 6.20% |
| `related_adrs` | 42 | 635 | 6.20% |
| `related_cores` | 42 | 635 | 6.20% |
| `implementation_refs` | 42 | 635 | 6.20% |
| `production_gate_impact` | 42 | 635 | 6.20% |
...
- Preserve the gradual migration rule: migrate a legacy document only when it is intentionally changed.
- Do not infer missing ownership, authority, status, maturity, or relationships.
- Keep templates synchronized with the human-readable Schema 1.0.0 contract.
- Add validation only in a separately authorized execution.
