...
test('SPRINT-REQ-09 closure audit is a connected canonical report', async () => {
  const document = await loadDocument(resolve(root, 'documentation/DOCUMENTATION-SPRINT-CLOSURE-AUDIT.md'), { root })
...
test('SPRINT-REQ-09 records accepted sprint requests and commit evidence', async () => {
  const report = await read('documentation/DOCUMENTATION-SPRINT-CLOSURE-AUDIT.md')
