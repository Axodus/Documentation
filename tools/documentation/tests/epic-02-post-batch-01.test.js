...
test('REQ-06 artifacts are canonical and use non-colliding IDs', async () => {
  const artifacts = [
    ['DOCUMENTATION-BATCH-01-ACCEPTANCE-REPORT.md', 'DOC-RPT-012'],
    ['DOCUMENTATION-BATCH-01-POST-MIGRATION-AUDIT.md', 'DOC-RPT-013'],
    ['DOCUMENTATION-EPIC-02-PROGRESS-REPORT.md', 'DOC-RPT-014'],
    ['DOCUMENTATION-BATCH-02-PLANNING.md', 'DOC-ROAD-004'],
    ['DOCUMENTATION-BATCH-02-CANDIDATE-FREEZE-PROPOSAL.md', 'DOC-ROAD-005'],
    ['DOCUMENTATION-BATCH-02-AUTHORITY-GAP-REPORT.md', 'DOC-RPT-015'],
  ]
...
test('Batch 01 is explicitly accepted with complete audit controls', async () => {
  const acceptance = await read('DOCUMENTATION-BATCH-01-ACCEPTANCE-REPORT.md')
  const audit = await read('DOCUMENTATION-BATCH-01-POST-MIGRATION-AUDIT.md')
