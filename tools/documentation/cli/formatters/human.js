...
function formatDispositions(payload) {
  const lines = [
    ...
    `Governed dispositions: ${payload.statistics.governed_dispositions}`,
    `Undecided dispositions: ${payload.statistics.undecided_dispositions}`,
    `Temporary extension candidates: ${payload.statistics.temporary_extension_candidates}`,
